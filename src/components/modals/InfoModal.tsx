...
const InfoModal = ({ title, children}: Props) => {
	...
	return (
		<>
			<div className="w-screen h-screen fixed top-0 left-0 right-0 bottom-0 bg-slate-500 backdrop-opacity-60 z-20">
				<div className="z-30 p-4 overflow-x-hidden overflow-y-auto">
